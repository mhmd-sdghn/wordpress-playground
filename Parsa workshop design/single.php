	...
	<main>
		...
		<article class="post">
			<header>
				...
				<p class="aouter"><i class="fas fa-user-alt"></i> نویسنده : <?php the_author(); ?> </p>
				<p class="date"><i class="fas fa-calendar-alt"></i> تاریخ : <?php  echo get_the_date("d F y"); ?></p>
				<p class="comments_counter"><i class="fas fa-comments"></i> <?php echo get_comments_number(); ?> دیدگاه</p>
			...
			<footer class="post_footer">
				<p><i class="fas fa-tags"></i><?php the_tags( ' برچسب ها : ',' ، ' ); ?></p>
			</footer>
		</article>
		<div id="comment_box">
		<?php
